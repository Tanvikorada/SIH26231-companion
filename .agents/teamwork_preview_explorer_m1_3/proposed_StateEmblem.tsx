  ...
  return (
    ...
    >
      ...
      <g fill="currentColor">
        ...
        <circle cx="24.0" cy="146" r="1" fill="currentColor" />
        <circle cx="28.0" cy="146" r="1" fill="currentColor" />
        <circle cx="32.0" cy="146" r="1" fill="currentColor" />
        <circle cx="36.0" cy="146" r="1" fill="currentColor" />
        <circle cx="40.0" cy="146" r="1" fill="currentColor" />
        <circle cx="44.0" cy="146" r="1" fill="currentColor" />
        <circle cx="48.0" cy="146" r="1" fill="currentColor" />
        <circle cx="52.0" cy="146" r="1" fill="currentColor" />
        <circle cx="56.0" cy="146" r="1" fill="currentColor" />
        <circle cx="60.0" cy="146" r="1" fill="currentColor" />
        <circle cx="64.0" cy="146" r="1" fill="currentColor" />
        <circle cx="68.0" cy="146" r="1" fill="currentColor" />
        <circle cx="72.0" cy="146" r="1" fill="currentColor" />
        <circle cx="76.0" cy="146" r="1" fill="currentColor" />
        <circle cx="80.0" cy="146" r="1" fill="currentColor" />
        <circle cx="84.0" cy="146" r="1" fill="currentColor" />
        <circle cx="88.0" cy="146" r="1" fill="currentColor" />
        <circle cx="92.0" cy="146" r="1" fill="currentColor" />
        <circle cx="96.0" cy="146" r="1" fill="currentColor" />
        <circle cx="100.0" cy="146" r="1" fill="currentColor" />
        <circle cx="104.0" cy="146" r="1" fill="currentColor" />
        <circle cx="108.0" cy="146" r="1" fill="currentColor" />
        <circle cx="112.0" cy="146" r="1" fill="currentColor" />
        <circle cx="116.0" cy="146" r="1" fill="currentColor" />
        <circle cx="120.0" cy="146" r="1" fill="currentColor" />
        <circle cx="124.0" cy="146" r="1" fill="currentColor" />
        <circle cx="128.0" cy="146" r="1" fill="currentColor" />
        <circle cx="132.0" cy="146" r="1" fill="currentColor" />
        <circle cx="136.0" cy="146" r="1" fill="currentColor" />
        <circle cx="140.0" cy="146" r="1" fill="currentColor" />
        <circle cx="144.0" cy="146" r="1" fill="currentColor" />
        <circle cx="148.0" cy="146" r="1" fill="currentColor" />
        <circle cx="152.0" cy="146" r="1" fill="currentColor" />
        <circle cx="156.0" cy="146" r="1" fill="currentColor" />
        <circle cx="160.0" cy="146" r="1" fill="currentColor" />
        <circle cx="164.0" cy="146" r="1" fill="currentColor" />
        <circle cx="168.0" cy="146" r="1" fill="currentColor" />
        <circle cx="172.0" cy="146" r="1" fill="currentColor" />
        <circle cx="176.0" cy="146" r="1" fill="currentColor" />
        <rect x="20" y="148.5" width="160" height="1.5" />

        <rect x="20" y="177" width="160" height="1.5" />
        <circle cx="24.0" cy="180" r="1" fill="currentColor" />
        <circle cx="28.0" cy="180" r="1" fill="currentColor" />
        <circle cx="32.0" cy="180" r="1" fill="currentColor" />
        <circle cx="36.0" cy="180" r="1" fill="currentColor" />
        <circle cx="40.0" cy="180" r="1" fill="currentColor" />
        <circle cx="44.0" cy="180" r="1" fill="currentColor" />
        <circle cx="48.0" cy="180" r="1" fill="currentColor" />
        <circle cx="52.0" cy="180" r="1" fill="currentColor" />
        <circle cx="56.0" cy="180" r="1" fill="currentColor" />
        <circle cx="60.0" cy="180" r="1" fill="currentColor" />
        <circle cx="64.0" cy="180" r="1" fill="currentColor" />
        <circle cx="68.0" cy="180" r="1" fill="currentColor" />
        <circle cx="72.0" cy="180" r="1" fill="currentColor" />
        <circle cx="76.0" cy="180" r="1" fill="currentColor" />
        <circle cx="80.0" cy="180" r="1" fill="currentColor" />
        <circle cx="84.0" cy="180" r="1" fill="currentColor" />
        <circle cx="88.0" cy="180" r="1" fill="currentColor" />
        <circle cx="92.0" cy="180" r="1" fill="currentColor" />
        <circle cx="96.0" cy="180" r="1" fill="currentColor" />
        <circle cx="100.0" cy="180" r="1" fill="currentColor" />
        <circle cx="104.0" cy="180" r="1" fill="currentColor" />
        <circle cx="108.0" cy="180" r="1" fill="currentColor" />
        <circle cx="112.0" cy="180" r="1" fill="currentColor" />
        <circle cx="116.0" cy="180" r="1" fill="currentColor" />
        <circle cx="120.0" cy="180" r="1" fill="currentColor" />
        <circle cx="124.0" cy="180" r="1" fill="currentColor" />
        <circle cx="128.0" cy="180" r="1" fill="currentColor" />
        <circle cx="132.0" cy="180" r="1" fill="currentColor" />
        <circle cx="136.0" cy="180" r="1" fill="currentColor" />
        <circle cx="140.0" cy="180" r="1" fill="currentColor" />
        <circle cx="144.0" cy="180" r="1" fill="currentColor" />
        <circle cx="148.0" cy="180" r="1" fill="currentColor" />
        <circle cx="152.0" cy="180" r="1" fill="currentColor" />
        <circle cx="156.0" cy="180" r="1" fill="currentColor" />
        <circle cx="160.0" cy="180" r="1" fill="currentColor" />
        <circle cx="164.0" cy="180" r="1" fill="currentColor" />
        <circle cx="168.0" cy="180" r="1" fill="currentColor" />
        <circle cx="172.0" cy="180" r="1" fill="currentColor" />
        <circle cx="176.0" cy="180" r="1" fill="currentColor" />
        ...
        <line x1="27.0" y1="164.7" x2="24.3" y2="169.5" stroke="currentColor" strokeWidth="0.8" />
        ...
        <line x1="26.3" y1="162.0" x2="21.5" y2="159.3" stroke="currentColor" strokeWidth="0.8" />
        ...
        <line x1="29.7" y1="162.0" x2="34.5" y2="159.3" stroke="currentColor" strokeWidth="0.8" />
        ...
        <line x1="171.0" y1="164.7" x2="168.3" y2="169.5" stroke="currentColor" strokeWidth="0.8" />
        ...
        <line x1="170.3" y1="162.0" x2="165.5" y2="159.3" stroke="currentColor" strokeWidth="0.8" />
        <line x1="171.0" y1="161.3" x2="168.3" y2="156.5" stroke="currentColor" strokeWidth="0.8" />
        ...
        <line x1="173.7" y1="162.0" x2="178.5" y2="159.3" stroke="currentColor" strokeWidth="0.8" />
