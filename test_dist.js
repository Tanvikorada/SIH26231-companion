...
const testNeg = [165,161,156];
const labNeg = rgb2lab(testNeg);
console.log("Dist to Diazepam POS:", deltaE00(labNeg, rgb2lab([163,156,132])));
console.log("Dist to Methadone POS:", deltaE00(labNeg, rgb2lab([168,160,142])));
