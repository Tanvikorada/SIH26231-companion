...
export function StampBadge({
  ...
  // Fallbacks support CSS variables --color-navy (#003366) and --color-brass (#855800)
  const variantStyles: Record<StampBadgeVariant, {
    ...
    brass: {
      border: "border-[var(--color-brass,#855800)]",
      text: "text-[var(--color-brass,#855800)]",
      bg: "bg-amber-50/80",
      outline: "outline-[var(--color-brass,#855800)]",
